...
void Pairs_from_File(
    const std::string & pairs_file, const std::shared_ptr<Data::Geometry> geometry, int & nop, pairfield & exchange_pairs,
...
void Quadruplets_from_File(
    const std::string & quadruplets_file, const std::shared_ptr<Data::Geometry>, int & noq, quadrupletfield & quadruplets,
